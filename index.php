...
<body class="bg-slate-100">
 ...
 <div class="class lg:w-1/2 ml-auto mr-auto mt-60 text-center ">
    <h1 class="text-3xl font-bold text-center text-black mb-2">Luxe Layers</h1>
    <p class="text-lg text-black mb-4">Welcome to Luxe Layers,Sophisticated style for every seasons.</p>
    <div class="space-x-4">
